...
function SkeletonLoading() {
    return (
        <div className=" space-y-4">
            {
                [1, 2, 3, 4, 5].map(i => (
                    <div key={i} className=" rounded-xl relative overflow-hidden border border-border backdrop-blur-sm shadow-lg dark:shadow-black/50 group">
                        ...
                        <div className=" flex flex-col md:flex-row gap-4 items-center">
                            <div className=" w-full md:w-25 h-25 overflow-hidden bg-muted/50"></div>
                            <div className=" px-4 md:py-4 w-full flex-1 overflow-hidden text-center md:text-left">
                            ...
                            <div className=" px-4 md:py-4 pb-4 md:pb-0 flex gap-4 items-center flex-nowrap">
